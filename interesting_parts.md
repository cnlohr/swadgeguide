Just some interesting/useful parts I've found and want to keep tabs on:
...
| Buck, up to 16V in, up to 2A out.  Minimal other components.  Rock solid, cnlohr tested and approved :) | $0.06 |
